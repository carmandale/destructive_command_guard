...
static PACK_ENTRIES: [PackEntry; 82] = [
    ...
    PackEntry::new(
        "storage.gcs",
        storage::gcs::KEYWORDS,
        storage::gcs::create_pack,
    ),
    PackEntry::new(
        "storage.minio",
        storage::minio::KEYWORDS,
        storage::minio::create_pack,
    ),
    PackEntry::new(
        "storage.azure_blob",
        storage::azure_blob::KEYWORDS,
        storage::azure_blob::create_pack,
    ),
    PackEntry::new(
        "remote.rsync",
        remote::rsync::KEYWORDS,
        remote::rsync::create_pack,
    ),
    PackEntry::new(
        "remote.ssh",
        remote::ssh::KEYWORDS,
    ...
    PackEntry::new(
        "remote.scp",
        remote::scp::KEYWORDS,
        remote::scp::create_pack,
    ),
    PackEntry::new(
        "cicd.github_actions",
        cicd::github_actions::KEYWORDS,
        cicd::github_actions::create_pack,
    ),
    PackEntry::new(
        "cicd.gitlab_ci",
        cicd::gitlab_ci::KEYWORDS,
        cicd::gitlab_ci::create_pack,
    ),
    PackEntry::new(
        "cicd.jenkins",
        cicd::jenkins::KEYWORDS,
        cicd::jenkins::create_pack,
    ),
    PackEntry::new(
        "cicd.circleci",
        cicd::circleci::KEYWORDS,
        cicd::circleci::create_pack,
    ),
    PackEntry::new(
        "secrets.vault",
        secrets::vault::KEYWORDS,
        secrets::vault::create_pack,
    ),
    PackEntry::new(
        "secrets.aws_secrets",
        secrets::aws_secrets::KEYWORDS,
        secrets::aws_secrets::create_pack,
    ),
    PackEntry::new(
        "secrets.onepassword",
        secrets::onepassword::KEYWORDS,
        secrets::onepassword::create_pack,
    ),
    PackEntry::new(
        "secrets.doppler",
        secrets::doppler::KEYWORDS,
        secrets::doppler::create_pack,
    ),
    PackEntry::new(
        "platform.github",
        platform::github::KEYWORDS,
        platform::github::create_pack,
    ),
    PackEntry::new(
        "platform.gitlab",
        platform::gitlab::KEYWORDS,
        platform::gitlab::create_pack,
    ),
    PackEntry::new(
        "dns.cloudflare",
        dns::cloudflare::KEYWORDS,
    ...
    PackEntry::new(
        "payment.braintree",
        payment::braintree::KEYWORDS,
        payment::braintree::create_pack,
    ),
    PackEntry::new(
        "payment.square",
        payment::square::KEYWORDS,
        payment::square::create_pack,
    ),
    PackEntry::new(
        "messaging.kafka",
        messaging::kafka::KEYWORDS,
        messaging::kafka::create_pack,
    ),
    PackEntry::new(
        "messaging.rabbitmq",
        messaging::rabbitmq::KEYWORDS,
        messaging::rabbitmq::create_pack,
    ),
    PackEntry::new(
        "messaging.nats",
        messaging::nats::KEYWORDS,
        messaging::nats::create_pack,
    ),
    PackEntry::new(
        "messaging.sqs_sns",
        messaging::sqs_sns::KEYWORDS,
        messaging::sqs_sns::create_pack,
    ),
    PackEntry::new(
        "search.elasticsearch",
        search::elasticsearch::KEYWORDS,
        search::elasticsearch::create_pack,
    ),
    PackEntry::new(
        "search.opensearch",
        search::opensearch::KEYWORDS,
        search::opensearch::create_pack,
    ),
    PackEntry::new(
        "search.algolia",
        search::algolia::KEYWORDS,
        search::algolia::create_pack,
    ),
    PackEntry::new(
        "search.meilisearch",
        search::meilisearch::KEYWORDS,
        search::meilisearch::create_pack,
    ),
    PackEntry::new(
        "backup.borg",
        backup::borg::KEYWORDS,
        backup::borg::create_pack,
    ),
    PackEntry::new(
        "backup.rclone",
        backup::rclone::KEYWORDS,
        backup::rclone::create_pack,
    ),
    PackEntry::new(
        "backup.restic",
        backup::restic::KEYWORDS,
        backup::restic::create_pack,
    ),
    PackEntry::new(
        "backup.velero",
        backup::velero::KEYWORDS,
        backup::velero::create_pack,
    ),
    PackEntry::new(
        "database.postgresql",
        database::postgresql::KEYWORDS,
        database::postgresql::create_pack,
    ),
    PackEntry::new(
        "database.mysql",
        database::mysql::KEYWORDS,
        database::mysql::create_pack,
    ),
    PackEntry::new(
        "database.mongodb",
        database::mongodb::KEYWORDS,
        database::mongodb::create_pack,
    ),
    PackEntry::new(
        "database.redis",
        database::redis::KEYWORDS,
        database::redis::create_pack,
    ),
    PackEntry::new(
        "database.sqlite",
        database::sqlite::KEYWORDS,
        database::sqlite::create_pack,
    ),
    PackEntry::new(
        "containers.docker",
        containers::docker::KEYWORDS,
        containers::docker::create_pack,
    ),
    PackEntry::new(
        "containers.compose",
        containers::compose::KEYWORDS,
        containers::compose::create_pack,
    ),
    PackEntry::new(
        "containers.podman",
        containers::podman::KEYWORDS,
        containers::podman::create_pack,
    ),
    PackEntry::new(
        "kubernetes.kubectl",
        kubernetes::kubectl::KEYWORDS,
        kubernetes::kubectl::create_pack,
    ),
    PackEntry::new(
        "kubernetes.helm",
        kubernetes::helm::KEYWORDS,
        kubernetes::helm::create_pack,
    ),
    PackEntry::new(
        "kubernetes.kustomize",
        kubernetes::kustomize::KEYWORDS,
        kubernetes::kustomize::create_pack,
    ),
    PackEntry::new("cloud.aws", cloud::aws::KEYWORDS, cloud::aws::create_pack),
    PackEntry::new("cloud.gcp", cloud::gcp::KEYWORDS, cloud::gcp::create_pack),
    PackEntry::new(
        "cloud.azure",
        cloud::azure::KEYWORDS,
        cloud::azure::create_pack,
    ),
    PackEntry::new(
        "cdn.cloudflare_workers",
        cdn::cloudflare_workers::KEYWORDS,
        cdn::cloudflare_workers::create_pack,
    ),
    PackEntry::new(
        "cdn.fastly",
        cdn::fastly::KEYWORDS,
        cdn::fastly::create_pack,
    ),
    PackEntry::new(
        "cdn.cloudfront",
        cdn::cloudfront::KEYWORDS,
        cdn::cloudfront::create_pack,
    ),
    PackEntry::new(
        "apigateway.aws",
        apigateway::aws::KEYWORDS,
        apigateway::aws::create_pack,
    ),
    PackEntry::new(
        "apigateway.kong",
        apigateway::kong::KEYWORDS,
        apigateway::kong::create_pack,
    ),
    PackEntry::new(
        "apigateway.apigee",
        apigateway::apigee::KEYWORDS,
        apigateway::apigee::create_pack,
    ),
    PackEntry::new(
        "infrastructure.terraform",
        infrastructure::terraform::KEYWORDS,
        infrastructure::terraform::create_pack,
    ),
    PackEntry::new(
        "infrastructure.ansible",
        infrastructure::ansible::KEYWORDS,
        infrastructure::ansible::create_pack,
    ),
    PackEntry::new(
        "infrastructure.pulumi",
        infrastructure::pulumi::KEYWORDS,
        infrastructure::pulumi::create_pack,
    ),
    PackEntry::new(
        "system.disk",
        system::disk::KEYWORDS,
        system::disk::create_pack,
    ),
    PackEntry::new(
        "system.permissions",
        system::permissions::KEYWORDS,
        system::permissions::create_pack,
    ),
    PackEntry::new(
        "system.services",
        system::services::KEYWORDS,
        system::services::create_pack,
    ),
    PackEntry::new("strict_git", strict_git::KEYWORDS, strict_git::create_pack),
    PackEntry::new(
        "package_managers",
        package_managers::KEYWORDS,

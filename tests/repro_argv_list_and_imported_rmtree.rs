...
//! column is dcg main at 88777c5c, which is what HEAD was when the rows were
//! read. Every row was re-read on 56f22bc2 -- after `.agent-config-artmu`
//! rewrote the python rules to be module-bound and 8c0246d0 landed a
//! here-string fix -- and none of them moved.
//!

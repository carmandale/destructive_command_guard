...
| Pattern Name | Pattern |
|--------------|----------|
| `find-temp-root` | `find\s+(?:-[HLPEdsx]+\s+)*(?:(?:/tmp\|/var/tmp\|\$TMPDIR\|\$\{TMPDIR\}\|\$\{TMPDIR:\?\}\|\$\{TMPDIR:-/tmp\}\|\$\{TMPDIR:-/var/tmp\}\|__RESOLVED_TMPDIR__)(?:/(?!\.\.(?:/\|\s\|$)\|[^\s]*/\.\.(?:/\|\s\|$))[^\s;&\|]*)?\|\$\{TMPDIR(?::\?)?\}(?!\.\.(?:/\|\s\|$)\|[^\s]*/\.\.(?:/\|\s\|$))[^\s;&\|]+\|"(?:\$TMPDIR\|\$\{TMPDIR\}\|\$\{TMPDIR:\?\}\|\$\{TMPDIR:-/tmp\}\|\$\{TMPDIR:-/var/tmp\})(?:/(?!(?:[^"]*/)?\.\.(?:/\|"))[^"]*)?"\|"\$\{TMPDIR(?::\?)?\}(?!(?:[^"]*/)?\.\.(?:/\|"))[^"]+")(?:\s+-\|\s*$)` |
